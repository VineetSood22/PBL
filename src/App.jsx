...
import Recommendations from "./components/routes/recommendations/Recommendations.jsx";
      ...
      <div className="app tracking-tighter min-w-[320px]">
        ...
        <div className="container max-w-[1024px] w-full min-w-[320px] h-auto">
          <Routes>
            ...
            <Route
              path="/profile"
              element={isAuthenticated ? <Profile /> : <Hero />}
            />
            <Route
              path="/recommendations"
              element={isAuthenticated ? <Recommendations /> : <Hero />}
            />
            <Route
              path="/analytics"
              element={isAuthenticated ? <Analytics /> : <Hero />}
            />
